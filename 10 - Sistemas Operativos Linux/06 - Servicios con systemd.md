...
systemctl list-unit-files --type=service        # Todos con su estado de boot
```
...
systemctl edit nginx                # Editar/sobrescribir sin tocar el original
...
> [!tip] Recordatorio clave
> Después de editar cualquier unit file siempre ejecuta `systemctl daemon-reload` para que systemd lea los cambios.

---
🔗 Relacionado: [[05 - Usuarios, grupos y permisos]] · [[07 - Logs y auditoría]]
