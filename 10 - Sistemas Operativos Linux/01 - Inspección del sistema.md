...
tags:
  ...
  - hardware
aliases:
  - Inspección del sistema Linux
  - Información del sistema
---

# Inspección del sistema

**Antes de tocar cualquier cosa en un servidor, primero mira qué hay. Estos comandos te dan el mapa completo del sistema: kernel, hardware, memoria y dispositivos.**
...
dmidecode -t system         # Fabricante, modelo, serial (requiere root)
...
**Antes de instalar software pesado**, verifica RAM y CPU disponibles:
...
> Combina varios comandos en una sola línea para un vistazo rápido del estado general: `uname -a && uptime && free -h && df -h`.

---
🔗 Relacionado: [[02 - Red y conectividad]] · [[SSH en Linux]]
