...
tags:
  ...
  - filesystems
aliases:
  - Almacenamiento y filesystems en Linux
...
> [!info] Instalación
> Los comandos SMART requieren el paquete `smartmontools`: `apt install smartmontools`.
...
> [!warning] dd es destructivo
> `dd` no pide confirmación. Un `of=` apuntado al dispositivo equivocado destruye datos al instante. Verifica dos veces antes de ejecutar.

---
🔗 Relacionado: [[03 - Procesos y rendimiento]] · [[05 - Usuarios, grupos y permisos]] · [[09 - Backups y recuperación]]
