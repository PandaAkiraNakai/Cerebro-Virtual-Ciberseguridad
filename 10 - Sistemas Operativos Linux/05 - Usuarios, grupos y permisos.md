...
> [!info] Tabla de valores octal
> `4 = leer (r)`, `2 = escribir (w)`, `1 = ejecutar (x)`. Se suman: `7=rwx`, `6=rw-`, `5=r-x`, `4=r--`, `0=---`.
...
> [!warning] Edita sudoers solo con visudo
> `visudo` valida la sintaxis antes de guardar. Un error tipográfico editando `/etc/sudoers` directamente puede dejarte sin acceso a sudo.
...
setfacl -m u:usuario:rw archivo      # Lectura/escritura a usuario específico
setfacl -m g:grupo:r archivo         # Lectura a grupo específico
...
---
🔗 Relacionado: [[04 - Almacenamiento y filesystems]] · [[06 - Servicios con systemd]] · [[08 - Seguridad del servidor]]
