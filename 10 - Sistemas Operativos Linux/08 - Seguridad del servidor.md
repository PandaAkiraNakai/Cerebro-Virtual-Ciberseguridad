...
ssh-keygen -t ed25519 -C "comentario"           # Ed25519 (recomendado, más seguro)
ssh-keygen -t rsa -b 4096 -C "comentario"        # RSA 4096 bits (alternativa)
...
> [!warning] Verifica antes de cerrar la puerta
> Confirma que puedes entrar con clave pública en una sesión nueva ANTES de poner `PasswordAuthentication no`. De lo contrario podrías quedar fuera del servidor.
...
debsums -c                              # Verifica checksums (Debian)
...
# Bloquear acceso a /proc/PID de otros usuarios (en /etc/fstab)
...
---
🔗 Relacionado: [[07 - Logs y auditoría]] · [[09 - Backups y recuperación]] · [[SSH en Linux]]
