...
const char* THINGSBOARD_TOKEN = "TU_TOKEN_THINGSBOARD";
const char* THINGSBOARD_SERVER = "IP_DEL_SERVIDOR_THINGSBOARD";
...
<body>
  ...
  <script>
    ...
    setInterval(updateData, 3000); // Actualizacion cada 3 segundos
    updateData();
  </script>
</body>
</html>
